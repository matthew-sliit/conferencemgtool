    ...
    render() {
        return <React.Fragment>
            <div className="d justify-content-center ">
                <h3 class="text-dark">Dashboard of Reviewer</h3>
                <div className="card">
                    <div className="card-body">
                        <div className="container">
                            <h4><b>Status of Conference Papers</b></h4><br/><br/>
                            ...
                            <br/>
                            <div id={"workp_id"}><h4><b>Status of Workshop Papers</b></h4></div>
                            <div style={{display: "table-cell"}}>
                                <div id="approved-ws-chart"
                                     style={{position: "relative", left: "0px", top: "-118px"}}></div>
                            </div>
                            <div style={{display: "table-cell"}}>
                                <div id="rejected-ws-chart"
                                     style={{position: "relative", left: "20px", top: "-118px"}}></div>
                            </div>
                            <div style={{display: "table-cell"}}>
                                <div id="remain-ws-chart"
                                     style={{position: "relative", left: "40px", top: "-118px"}}></div>
                            </div>
                        </div>
                    </div>
                </div>
